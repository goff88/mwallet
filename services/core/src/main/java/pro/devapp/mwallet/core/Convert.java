...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "PRIZM-" + Crypto.rsEncode(accountId);
    }
...
//    if(s==null)s="";
    ...
    public static long parsePRIZM(String prizm) {
        return parseStringFraction(prizm, 8, Constants.MAX_BALANCE_PRIZM);
    }
